...
const NewsItem = (props) => {
  ...
  return (
    <div className="h-full flex flex-col card max-w-lg bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="card-body py-2 px-4 flex flex-col flex-grow">
        <div className="flex items-center justify-between gap-0.75 mb-2">
          ...
          <span
            className={`text-xs font-bold px-1.5 py-1 rounded-sm border ${getTimeAgo(publishedAt).className} dark:bg-gray-200`}
          >
            {getTimeAgo(publishedAt).label}
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <span className="text-gray-300 text-sm font-medium px-2 py-1 ml-0.5 mt-2 lg:mt-0">
            By <span className="font-bold">{author ? author : "N/A"}</span> at{" "}
