    ...
    return (
      <div className='fixed top-0 w-full z-50'>
        ...
        <div className="flex md:order-2">
            ...
            <button onClick={toggleMenu} type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded={isMenuOpen ? 'true' : 'false'}>
            ...
            <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 md:block max-h-[80vh] overflow-y-auto overflow-x-hidden ${isMenuOpen ? 'block' : 'hidden'}`} id="navbar-search">
    ...
    `block py-2 px-3 rounded-sm md:p-0 ${
      isActive
        ...
        : 'text-gray-900 dark:text-white'
                ...
                <li>
                    <NavLink to="/business" onClick={closeMenu} className={({ isActive }) =>
    `block py-2 px-3 rounded-sm md:p-0 ${
      isActive
        ? 'text-blue-700 md:text-blue-700 dark:text-blue-400'
        : 'text-gray-900 dark:text-white'
                ...
                <li>
                    <NavLink to="/entertainment" onClick={closeMenu} className={({ isActive }) =>
    `block py-2 px-3 rounded-sm md:p-0 ${
      isActive
        ? 'text-blue-700 md:text-blue-700 dark:text-blue-400'
        : 'text-gray-900 dark:text-white'
                ...
                <li>
                    <NavLink to="/health" onClick={closeMenu} className={({ isActive }) =>
    `block py-2 px-3 rounded-sm md:p-0 ${
      isActive
        ? 'text-blue-700 md:text-blue-700 dark:text-blue-400'
        : 'text-gray-900 dark:text-white'
                ...
                <li>
                    <NavLink to="/science" onClick={closeMenu} className={({ isActive }) =>
    `block py-2 px-3 rounded-sm md:p-0 ${
      isActive
        ? 'text-blue-700 md:text-blue-700 dark:text-blue-400'
        : 'text-gray-900 dark:text-white'
                ...
                <li>
                    <NavLink to="/sports" onClick={closeMenu} className={({ isActive }) =>
    `block py-2 px-3 rounded-sm md:p-0 ${
      isActive
        ? 'text-blue-700 md:text-blue-700 dark:text-blue-400'
        : 'text-gray-900 dark:text-white'
                ...
                <li>
                    <NavLink to="/technology" onClick={closeMenu} className={({ isActive }) =>
    `block py-2 px-3 rounded-sm md:p-0 ${
      isActive
        ? 'text-blue-700 md:text-blue-700 dark:text-blue-400'
        : 'text-gray-900 dark:text-white'
